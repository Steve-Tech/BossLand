...
public class BossLand extends JavaPlugin implements Listener {
    ...
    private String getBossItemName(String b, int l) {
        return ChatColor.translateAlternateColorCodes('&', getConfig().getString("bosses." + b + ".loot." + l + ".name"));
    }
    ...
    private String getLang(String s) {
        ...
        return ChatColor.translateAlternateColorCodes('&', langFile.getString(s));
    }
    ...
    private ArrayList<String> getLangList(String s) {
        ...
        for (String l : list)
            list2.add(ChatColor.translateAlternateColorCodes('&', l));
        return list2;
    }
...
//						}
        ...
        } else if (e.getDamager() != null && !e.getEntity().getPassengers().isEmpty()) {
            //Mount Damage Stop
    ...
    private void spawnTornado(Location l, LivingEntity target, int dmg, String type) {
        ...
        bat.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(2000);
        bat.setHealth(2000);
                ...
                switch (bossType) {
                    ...
                    case "Devil": {
                        ...
                        if (phase == 2) {
                            ...
                            minion.addPotionEffect(new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 999 * 999, 5));
                            minion.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(200);
...
//				}
    ...
    private boolean godsDead() {
        return saveFile.getInt("drownedGodDeaths") > 0 && saveFile.getInt("pharaohGodDeaths") > 0 && saveFile.getInt("aetherGodDeaths") > 0;
    }
...
//	    	}
        ...
        try {
            ...
            if (getConfig().getList("disabledWorlds").contains(l.getWorld().getName())) {
                for (Entity e : getNearbyEntities(l, 24, new ArrayList<>(Collections.singletonList(EntityType.PLAYER))))
                    e.sendMessage(getLang("failSpawnWorld"));
                return;
            }
            //Check World Guard
            ...
            if (bossMap.size() >= getConfig().getInt("bossLimit")) {
                for (Entity e : getNearbyEntities(l, 24, new ArrayList<>(Collections.singletonList(EntityType.PLAYER))))
                    e.sendMessage(getLang("tooManyBosses"));
                return;
            }
            //Log Spawn
    ...
    public void makeBoss(Entity ent, String bossType) {
        ...
        //Name
        ent.setCustomName(ChatColor.translateAlternateColorCodes('&', getConfig().getString("bosses." + bossType + ".name")));
    ...
    public ItemStack getLoot(Entity p, String bossType) {
        List<String> list = new ArrayList<>(getConfig().getConfigurationSection("bosses." + bossType + ".loot").getKeys(false));
        ItemStack s = null;
        int i = 256;
        do {
            //Get Item
...
//		}
    ...
    static class WorldGuardMethods {
        WorldGuardMethods() {
        }
